...
qss = "QWidget{""background-color: hsl(0,0%,50%);""}"
                  "QTextEdit{""background-color: hsl(0,0%,100%);""border-color: hsl(240,100%,50%);""border: 5px solid hsl(240,100%,50%);""}"
                  ...
                  "QToolButton{""border-radius: 00px;""background-color: hsl(0,0%,50%);""qproperty-iconSize: 30px 30px;""}"
                  "QToolButton:pressed{"" border-radius: 10px;""background-color: hsl(240,100%,50%);""}";
