...
menu_bar = new QMenuBar(this);
    ...
    action_add_DateTime = new QAction(this);
    connect(action_add_DateTime, SIGNAL(triggered(bool)), this, SLOT(on_but_Insert_DateTime_clicked()));
    ...
    edit_menu->addAction(action_add_DateTime);
...
void EditorTexts::on_but_Insert_DateTime_clicked()
{
    ...
    editorTexts->insertPlainText(time + " " + date);
}
